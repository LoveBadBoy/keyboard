...
-(void)drawRect:(CGRect)rect{
    ...
    UIImage *videoIcon=[UIImage imageNamed:@"AssetsPickerVideo"];
...
+ (void)initialize
{
    checkedIcon     = [UIImage imageNamed:@"define_tag"];
...
-(id)initWithFrame:(CGRect)frame{
    if (self=[super initWithFrame:frame]) {
        _selectView=[[UIImageView alloc] initWithFrame:CGRectMake(frame.size.width-30.0, frame.size.height-30.0, 25.0, 25.0)];
...
//    NSLog(@"_indexPathsForSelectedItems:%i",[_indexPathsForSelectedItems count]);
